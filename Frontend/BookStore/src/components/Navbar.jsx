...
function Navbar({ inputValue, handleInputChange }) {
                    ...
                    <div className="navbar-start">
                        <div className="dropdown">
                            ...
                            <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52 dark:bg-slate-900 dark:text-white">
                                <li className='hover:dark:bg-slate-950'>
                                    <Link to="/">
                                        Home
                                    </Link>
                                </li>
                    ...
                    <div className='navbar-end space-x-3'>
                        ...
                        <div className='hidden md:block'>
                            <label className="px-3 py-2 border rounded-md flex items-center gap-2">
                                <input
                                    type="text"
                                    className={`grow outline-none dark:bg-slate-900 dark:text-white ${sticky ? "dark:bg-slate-950" : "" }`}
                                    placeholder="Search"
                                    value={inputValue}
